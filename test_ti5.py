...
def design_scene():
    ...
    spawn=sim_utils.UsdFileCfg(
            usd_path=f"source/extensions/omni.isaac.lab_tasks/omni/isaac/lab_tasks/direct/ti5_hand/arm2_assets/inspire_hand_left.usd",   # revlative path to the bash/terminal
